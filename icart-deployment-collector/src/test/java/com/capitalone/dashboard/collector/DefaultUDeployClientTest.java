...
public class DefaultUDeployClientTest {
    ...
    @Mock private IcartSettings settings;

    private DefaultIcartClient defaultUDeployClient;
...
//    private static final String URL = "URL";
    ...
    public void init() {
        ...
        settings = new IcartSettings();
        defaultUDeployClient = new DefaultIcartClient(settings, restOperationsSupplier);
    }
    @Test
    public void testGetApplications() throws Exception {
        ...
        List<IcartApplication> apps = defaultUDeployClient.getApplications(instanceUrl);
    ...
    public void testGetEnvironmentResourceStatusData() throws Exception {
        ...
        List<IcartEnvResCompData> data = defaultUDeployClient.getEnvironmentResourceStatusData(apps.get(0), envs.get(0));
